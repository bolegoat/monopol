...
(function () {
  const ICONS = {
    ...
    link: '<path d="M9.5 14.5 14.5 9.5"/><path d="M11 6.6 12.6 5a4.3 4.3 0 0 1 6.1 6.1L17 12.8"/><path d="M13 17.4 11.4 19a4.3 4.3 0 0 1-6.1-6.1L7 11.2"/>',
    trash: '<path d="M4.5 7h15"/><path d="M9.5 7V4.8h5V7"/><path d="m6.5 7 1 13h9l1-13"/><path d="M10.5 10.5v6m3-6v6"/>',
    hammer: '<path d="m14.2 4.6 5.2 5.2-2.4 2.4-5.2-5.2z"/><path d="M11.4 8.2 4 15.6l3.9 3.9 7.4-7.4"/>',
    scales: '<path d="M12 4v16"/><path d="M6 20h12"/><path d="M4 8h16"/><path d="M4 8 1.8 13h4.4L4 8z"/><path d="m20 8-2.2 5h4.4L20 8z"/>',
